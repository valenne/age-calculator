...
function page() {
	...
	return (
		<section className='mx-auto w-full min-h-full my-auto grid place-items-center bg-[rgba(219,219,219,1)]'>
			<div className=' flex flex-col gap-5 text-justify px-10 w-[500px]'>
